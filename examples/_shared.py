...
def add_output_argument(parser: argparse.ArgumentParser) -> None:
    parser.add_argument("--output-dir", type=Path, default=DEFAULT_OUTPUT, help="Directory for generated example files.")
...
def synthetic_c1s(points: int = 401) -> Spectrum:
    ...
    return Spectrum(energy, intensity, region="C 1s", sample_name="synthetic PDI-H-COOH", metadata={"data_origin": "deterministic synthetic"})
